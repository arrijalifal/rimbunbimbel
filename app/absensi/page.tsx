...
export default function AbsensiPage() {
  ...
  useEffect(() => {
    ...
    if (todayClasses.length > 0) {
      setHasClass(true);
      // Ambil jadwal pertama sebagai info utama
      ...
      setHasClass(false);
      // Cari jadwal berikutnya dalam 7 hari ke depan
      for (let i = 1; i <= 7; i++) {
  ...
  const handleAbsen = () => {
    // Simulasi proses absen
    setIsAbsen(true);
    // Tambahkan ke riwayat (opsional untuk demo)
    // Dalam implementasi nyata, ini akan terhubung ke backend
  };
    ...
    <div className="flex min-h-screen bg-[#f4faf6]">
      ...
      <div className="flex-1 lg:ml-0 min-h-screen">
        ...
        <main className="p-4 lg:p-8 max-w-6xl mx-auto">
          ...
          <div className="rounded-2xl p-6 shadow-md mb-6 bg-white transition-all hover:shadow-lg">
